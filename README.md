...
| [ScholarCopilot](https://github.com/TIGER-AI-Lab/ScholarCopilot) | <img src="https://img.shields.io/github/stars/TIGER-AI-Lab/ScholarCopilot?style=for-the-badge" height="36"> | Qwen-2.5-7B, HuggingFace, Gradio | Self-hosted open-weight model (TIGER-Lab/ScholarCopilot-v1) | COLM 2025. Academic writing assistant that autonomously decides when to cite via a learned `[RET]` token, retrieves from a 500K-paper corpus, and inserts accurate citations with one-click BibTeX; 40.1% top-1 retrieval accuracy, live HF demo. |
