...
| [AutoSci](https://github.com/skyllwt/AutoSci) | <img src="https://img.shields.io/github/stars/skyllwt/AutoSci?style=for-the-badge" height="36"> | **Claude Code** + MCP servers (Semantic Scholar, llm-chat) | Anthropic Claude (primary); any OpenAI-compatible API (Review LLM) | Wiki-centric full-lifecycle AI research platform inspired by Karpathy's LLM-Wiki vision. 20+ Claude Code skills span ingest → ideate → novelty check → experiment design / run / eval → paper writing / compile. Research state lives in a structured knowledge wiki with interactive Cytoscape graph. |
