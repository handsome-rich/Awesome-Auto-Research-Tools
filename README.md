...
| [Deep Researcher Agent](https://github.com/Xiangyue-Zhang/auto-deep-researcher-24x7) | <img src="https://img.shields.io/github/stars/Xiangyue-Zhang/auto-deep-researcher-24x7?style=for-the-badge" height="36"> | Custom leader-worker loop, CLI tool use, optional SSH backend, progress notes | Anthropic-compatible and OpenAI-compatible APIs; Claude Code, Codex CLI | 24/7 autonomous deep learning experiment agent. Edits code, launches and monitors training, parses logs, and iterates while keeping zero-LLM-call monitoring, constant-size memory, and human-in-the-loop control. |
